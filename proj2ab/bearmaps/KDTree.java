...
/*        if (!n.flag) {
            if (goal.getX() - n.val.getX() < Point.distance(best.val, goal)) {
                best = nearest(badSide, goal, best);
            }
        } else {
            if (goal.getY() - n.val.getY() < Point.distance(best.val, goal)) {
                best = nearest(badSide, goal, best);
            }
        }*/
        return best;
